...
class Client extends Model
{
    ...
    public $forms = ['Client',
        ['title' => 'Dados Pessoais', 'text' => 'Digite os dados pessoais do cliente.',
            'fields' => ['name', 'email', 'rg', 'cpf', 'birth_date', 'phone', 'whatsapp', 'sex'],
            'model' => '\App\Models\Client', 'relations' => ['']],
        ['title' => 'Endereço', 'text' => 'Digite o endereço do cliente.', 'model' => '\App\Models\Address',
        ...
        ['title' => 'Circuito Primário', 'text' => 'Digite os dados do circuito primário do cliente', 'relations' => [''],
            'fields' => ['mode', 'user', 'password', 'mac', 'ip', 'plan_id'], 'model' => '\App\Models\Client'],
        ['title' => 'Circuito Secundário', 'text' => 'Digite os dados do circuito secundário do cliente', 'relations' => [''],
            'fields' => ['cto_id', 'splitter'], 'model' => '\App\Models\Client'],
        ['title' => 'Financeiro', 'text' => 'Digite os dados financeiros do cliente',
