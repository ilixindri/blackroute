@php Log::debug('line 1 of elements input.blade.php') @endphp
<div class="col-span-6 sm:col-span-4">
    ...
    @if(isset($field__datas["required"]))
...
//                        if(array_keys(array_slice($field__datas["onload"], 1, 1, true))[0] != 1) {
    ...
    @isset($object)
        ...
        @if(isset($field__datas["value"])) @if($field__datas["value"] == '') @php $value = ''; @endphp @endif @endif
