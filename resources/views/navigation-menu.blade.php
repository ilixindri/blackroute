                ...
                {{-- <div class="ml-3 relative hidden space-x-8 sm:-my-px sm:ml-10 sm:flex pt-4">
                    <x-jet-dropdown align="false" width="48">
                        <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                        <a href="{{ route('banking-carnets.index') }}">{{ __('Financeiro') }}</a>
                ...
                <div class="ml-3 relative hidden space-x-8 sm:-my-px sm:ml-10 sm:flex pt-4">
                    <x-jet-dropdown align="false" width="48">
                        <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none transition">
                                        <a href="{{ route('ctos.index') }}">Ctos</a>
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('ctos.create') }}">
                                {{ __('Nova Cto') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('ctos.index') }}">
                                {{ __('Listar Ctos') }}
                            </x-jet-dropdown-link>
                        </x-slot>
                    </x-jet-dropdown>
                ...
                <div class="ml-3 relative hidden space-x-8 sm:-my-px sm:ml-10 sm:flex pt-4">
                    <x-jet-dropdown align="false" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            <x-jet-dropdown-link href="{{ route('contracts.create') }}">
                                {{ __('Novo Contrato') }}
                            </x-jet-dropdown-link>

                            <x-jet-dropdown-link href="{{ route('contracts.index') }}">
                                {{ __('Listar Contratos') }}
                            </x-jet-dropdown-link>
                        </x-slot>
                    </x-jet-dropdown>
